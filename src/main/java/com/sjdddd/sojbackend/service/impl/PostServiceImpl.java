...
import com.sjdddd.sojbackend.mapper.PostMapper;
...
import com.sjdddd.sojbackend.model.entity.PostFavour;
...
public class PostServiceImpl extends ServiceImpl<PostMapper, Post> implements PostService {
    ...
    @Override
    public List<Post> getByTitleOrContent(String titleOrContent) {
        QueryWrapper<Post> queryWrapper = new QueryWrapper<>();
